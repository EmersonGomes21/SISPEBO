  ...
  return (
    <>
      ...
      <ul className={filterSelect === 'autoria' ? 'selectd' : 'no-select'}>
        ...
        <li className="todos"> <Filters type="checkbox" name="Todos" label="Todos" value={selectTodosAutoria} onClick={() => setSelectTodosAutoria(!selectTodosAutoria)} /> </li>

        <li><Filters type="checkbox" name="aut_nome" label="aut_nome" /></li>
